...
- `VISION.md`: Product vision, architecture overview, build plan, feature roadmap, and changelog. **This is the primary living document** — all bug fixes, feature plans, and architectural decisions are logged here.
