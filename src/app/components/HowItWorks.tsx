...
export default function HowItWorks() {
  ...
  return (
    <section id="how-it-works" ref={ref} className="py-24 bg-gray-950 relative">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="text-sky-400 text-sm font-medium tracking-wide uppercase">How it works</p>
        ...
        >
          {steps.map((step) => (
            <motion.div
              key={step.number}
              variants={fadeUpVariants}
              className="group relative bg-gray-900 border border-white/[0.06] rounded-xl p-6 hover:border-sky-500/20 transition-colors"
            >
