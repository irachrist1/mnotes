...
export default function Roadmap() {
  ...
  return (
    <section id="roadmap" ref={ref} className="py-24 bg-white dark:bg-gray-950">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="text-sky-500 dark:text-sky-400 text-sm font-medium tracking-wide uppercase">Roadmap</p>
        ...
        >
          {phases.map((phase) => (
            <motion.div
              key={phase.phase}
              variants={fadeUpVariants}
              className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-white/[0.06] rounded-xl p-5"
            >
              <div className="flex items-center justify-between mb-4">
                <div>
                  <p className="text-xs text-gray-400 dark:text-gray-500 font-mono">{phase.phase}</p>
                  <h3 className="text-base font-semibold text-gray-900 dark:text-white">{phase.title}</h3>
                </div>
