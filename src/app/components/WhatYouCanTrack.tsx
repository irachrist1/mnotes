...
export default function WhatYouCanTrack() {
  ...
  return (
    <section ref={ref} className="py-24 bg-gray-950 relative">
        ...
        >
          {capabilities.map((cap) => (
            <motion.div
              key={cap.label}
              variants={fadeUpVariants}
              className="flex items-start gap-3 bg-gray-900 border border-white/[0.06] rounded-lg p-4 hover:border-white/[0.1] transition-colors"
            >
