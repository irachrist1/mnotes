    ...
    <>
      <PageHeader title="Ideas Pipeline" description="Track ideas from conception to launch"
        action={
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => openCreate()} className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 text-sm font-medium hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors"><Plus className="w-3.5 h-3.5" />Add Idea</button>
          </div>
        }
      />
      ...
      {isLoading ? (
            ...
            return (
              <div key={stage.key} className="min-w-0">
                ...
                <div className="space-y-2">
                  {stageIdeas.map((idea) => (
                    <div key={idea._id} className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-3 hover:border-gray-300 dark:hover:border-gray-700 transition-colors group">
        ...
        <EmptyState icon={Lightbulb} title="No ideas yet" description="Start capturing your ideas to build your pipeline."
          action={<button onClick={() => openCreate()} className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 text-sm font-medium"><Plus className="w-3.5 h-3.5" />Add Idea</button>}
        />
      )}
